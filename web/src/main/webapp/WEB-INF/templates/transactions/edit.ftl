...
<@s.label for="from" value="From Account:" class="inline-block font-bold"/>
    ...
    <div class="w-56">
<@s.select name="bean.fromAccountId" id="from" list="accountsMap" value="bean.fromAccountId" class="bg-gray-200 p-2 w-full border-2 border-gray-200 rounded text-gray-800 focus:border-purple-500"/>
    </div>
...
<@s.label for="to" value="To Account:" class="inline-block font-bold"/>
    ...
    <div class="w-56">
<@s.select name="bean.toAccountId" id="to" list="accountsMap" value="bean.toAccountId" class="bg-gray-200 p-2 w-full border-2 border-gray-200 rounded text-gray-800 focus:border-purple-500"/>
    </div>
