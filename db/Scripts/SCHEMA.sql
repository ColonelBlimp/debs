...
DROP TRIGGER IF EXISTS TX_ENTRY_INSERT;
DROP TRIGGER IF EXISTS TX_ENTRY_UPDATE;
...
-- CREATE TRIGGER TX_ENTRY_INSERT AFTER INSERT ON DEBS.ENTRY FOR EACH ROW CALL "org.veary.debs.core.h2.triggers.TriggerAccountBalance";
...
INSERT INTO DEBS.ACCOUNT(NAME,DESCRIPTION,PARENT_ID,ACCOUNT_TYPE) VALUES('Income & Expenses', 'Build-In',1,8);
-- Income: 6
